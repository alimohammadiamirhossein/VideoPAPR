...
from .load_butterfly import load_blender_frame_data
...
def load_meta_data(args, mode="train"):
    ...
    if args.type == "synthetic":
        ...
        images, poses, hwf, image_paths = load_blender_frame_data(
            args.path, split=mode, factor=args.factor, read_offline=args.read_offline, frame_i="000"
        )
        print("Loaded blender", images.shape, hwf, args.path)
