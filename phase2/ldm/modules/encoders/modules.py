...
class FrozenT5Embedder(AbstractEncoder):
    ...
    def __init__(self, version="google/t5-v1_1-large", device= "cuda" if torch.cuda.is_available() else "cpu", max_length=77):  # others are google/t5-v1_1-xl and google/t5-v1_1-xxl
        super().__init__()
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device= "cuda" if torch.cuda.is_available() else "cpu", max_length=77):  # clip-vit-base-patch32
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = FrozenT5Embedder(version="google/t5-v1_1-xl").to(device)
