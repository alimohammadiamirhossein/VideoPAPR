...
parser.add_argument(
    '--views', type=int, default=7,
    help='number of views to be rendered')
parser.add_argument(
    'obj', type=str, default='/localhome/aaa324/Generative Models/Butterfly Example/ImageToStl.com_butterfly.obj',
    help='Path to the obj file to be rendered.')
parser.add_argument(
    '--output_folder', type=str, default='/localhome/aaa324/Generative Models/VideoPAPR/zero123plus/tmp',
...
# Now light_objects list contains all the light objects in the scene
print("Light Objects:")
print("#################################3")
for light_obj in light_objects:
    print(light_obj.name)
    # if 'Light' == light_obj.name:
...
elevation_angle_list = np.array([0, 30, 30, 30, 30, -20, -20, -20])
rotation_angle_list = np.array([0, 30, 150, 270, 90, 210, 330])
